...
class Instances {
    ...
    addInstance(
        ...
        if (!this._instances[component]) {
            console.warn(`Flowbite-Module: Component ${component} does not exist.`);

            return false;
        }

        if (this._instances[component][id] && !override) {
            console.warn(`Flowbite-Module: Instance with ID ${id} already exists.`);
    ...
    getInstance(component: keyof Instances['_instances'], id: string) {
        ...
        if (!this._instances[component][id]) {
            console.warn(`Flowbite-Module: Instance with ID ${id} does not exist.`);
...
if (typeof window !== 'undefined') {
    window.FlowbiteModuleInstances = instances;
}
